...
use super::{Err, Score, VAL_MASK, Version, encode::{EncodedMetric, EncodedVal}};
#[cfg(feature = "serde")]
...
mod tests {
  ...
  mod scores {
    ...
    fn test_hash() {
      let tests = vec![(
        "hash test", // test name
        Scores { macrovector: MacroVector(219), score: Score(75) }, // a
        Scores { macrovector: MacroVector::try_from(010011).unwrap(), score: Score::from(7.5) }, // b
      )];
