...
//!
//! ```
//! # use crate::polycvss::cvss::{Err, v4::{AttackVector, Vector, Metric, Name}};
//! # fn main() -> Result<(), Err> {
//! // parse vector string
...
//!
//! ```
//! # use crate::polycvss::cvss::{Err, v4::{Name, Vector}};
//! # fn main() -> Result<(), Err> {
//! // parse vector string
//! let v: Vector = "CVSS:4.0/AV:N/AC:L/AT:N/PR:N/UI:N/VC:H/VI:H/VA:H/SC:H/SI:H/SA:H".parse()?;
//!
...
//!
//! ```
//! # use crate::polycvss::cvss::{Err, Score, v4::Vector};
//! # fn main() -> Result<(), Err> {
//! // parse vector string
...
///
/// ```
/// # use crate::polycvss::cvss::{Err, v4::{AttackVector, Metric}};
/// # fn main() -> Result<(), Err> {
...
///
/// ```
/// # use crate::polycvss::cvss::v4::{AttackVector, Metric};
/// # fn main() {
/// // convert metric to string
...
///
/// ```
/// # use crate::polycvss::cvss::v4::{AttackVector, Metric, Name};
/// # fn main() {
/// // get metric name
...
///
/// ```
/// # use crate::polycvss::cvss::{Err, v4::{AttackComplexity, Metric}};
/// # fn main() -> Result<(), Err> {
/// // parse string as metric
...
///
/// ```
/// # use crate::polycvss::cvss::v4::{AttackComplexity, Metric};
/// # fn main() {
/// // convert metric to string
...
///
/// ```
/// # use crate::polycvss::cvss::v4::{AttackComplexity, Metric, Name};
/// # fn main() {
/// // get metric name
...
///
/// ```
/// # use crate::polycvss::cvss::{Err, v4::{AttackRequirements, Metric}};
/// # fn main() -> Result<(), Err> {
/// // parse string as metric
...
///
/// ```
/// # use crate::polycvss::cvss::v4::{AttackRequirements, Metric};
/// # fn main() {
/// // convert metric to string
...
///
/// ```
/// # use crate::polycvss::cvss::v4::{AttackRequirements, Metric, Name};
/// # fn main() {
/// // get metric name
...
///
/// ```
/// # use crate::polycvss::cvss::{Err, v4::{PrivilegesRequired, Metric}};
/// # fn main() -> Result<(), Err> {
/// // parse string as metric
...
///
/// ```
/// # use crate::polycvss::cvss::v4::{PrivilegesRequired, Metric};
/// # fn main() {
/// // convert metric to string
...
///
/// ```
/// # use crate::polycvss::cvss::v4::{PrivilegesRequired, Metric, Name};
/// # fn main() {
/// // get metric name
...
///
/// ```
/// # use crate::polycvss::cvss::{Err, v4::{UserInteraction, Metric}};
/// # fn main() -> Result<(), Err> {
/// // parse string as metric
...
///
/// ```
/// # use crate::polycvss::cvss::v4::{UserInteraction, Metric};
/// # fn main() {
/// // convert metric to string
...
///
/// ```
/// # use crate::polycvss::cvss::v4::{UserInteraction, Metric, Name};
/// # fn main() {
/// // get metric name
...
///
/// ```
/// # use crate::polycvss::cvss::{Err, v4::{ExploitMaturity, Metric}};
/// # fn main() -> Result<(), Err> {
/// // parse string as metric
...
///
/// ```
/// # use crate::polycvss::cvss::v4::{ExploitMaturity, Metric};
/// # fn main() {
/// // convert metric to string
...
///
/// ```
/// # use crate::polycvss::cvss::v4::{ExploitMaturity, Metric, Name};
/// # fn main() {
/// // get metric name
...
///
/// ```
/// # use crate::polycvss::cvss::{Err, v4::{Safety, Metric}};
/// # fn main() -> Result<(), Err> {
/// // parse string as metric
...
///
/// ```
/// # use crate::polycvss::cvss::v4::{Safety, Metric};
/// # fn main() {
/// // convert metric to string
...
///
/// ```
/// # use crate::polycvss::cvss::v4::{Safety, Metric, Name};
/// # fn main() {
/// // get metric name
...
///
/// ```
/// # use crate::polycvss::cvss::{Err, v4::{Automatable, Metric}};
/// # fn main() -> Result<(), Err> {
/// // parse string as metric
...
///
/// ```
/// # use crate::polycvss::cvss::v4::{Automatable, Metric};
/// # fn main() {
/// // convert metric to string
...
///
/// ```
/// # use crate::polycvss::cvss::v4::{Automatable, Metric, Name};
/// # fn main() {
/// // get metric name
...
///
/// ```
/// # use crate::polycvss::cvss::{Err, v4::{Recovery, Metric}};
/// # fn main() -> Result<(), Err> {
/// // parse string as metric
...
///
/// ```
/// # use crate::polycvss::cvss::v4::{Recovery, Metric};
/// # fn main() {
/// // convert metric to string
...
///
/// ```
/// # use crate::polycvss::cvss::v4::{Recovery, Metric, Name};
/// # fn main() {
/// // get metric name
...
///
/// ```
/// # use crate::polycvss::cvss::{Err, v4::{ValueDensity, Metric}};
/// # fn main() -> Result<(), Err> {
/// // parse string as metric
...
///
/// ```
/// # use crate::polycvss::cvss::v4::{ValueDensity, Metric};
/// # fn main() {
/// // convert metric to string
...
///
/// ```
/// # use crate::polycvss::cvss::v4::{ValueDensity, Metric, Name};
/// # fn main() {
/// // get metric name
...
///
/// ```
/// # use crate::polycvss::cvss::{Err, v4::{VulnerabilityResponseEffort, Metric}};
/// # fn main() -> Result<(), Err> {
/// // parse string as metric
...
///
/// ```
/// # use crate::polycvss::cvss::v4::{VulnerabilityResponseEffort, Metric};
/// # fn main() {
/// // convert metric to string
...
///
/// ```
/// # use crate::polycvss::cvss::v4::{VulnerabilityResponseEffort, Metric, Name};
/// # fn main() {
/// // get metric name
...
///
/// ```
/// # use crate::polycvss::cvss::{Err, v4::{ProviderUrgency, Metric}};
/// # fn main() -> Result<(), Err> {
/// // parse string as metric
...
///
/// ```
/// # use crate::polycvss::cvss::v4::{ProviderUrgency, Metric};
/// # fn main() {
/// // convert metric to string
...
///
/// ```
/// # use crate::polycvss::cvss::v4::{ProviderUrgency, Metric, Name};
/// # fn main() {
/// // get metric name
...
///
/// ```
/// # use crate::polycvss::cvss::v4::{Group, Name};
/// # fn main() {
/// // get group
...
///
/// ```
/// # use crate::polycvss::cvss::v4::{AttackVector, Name};
/// # fn main() {
/// // check if metric is mandatory
...
pub enum Metric {
  ...
  ///
  /// ```
  /// # use crate::polycvss::cvss::{Err, v4::{Impact, Metric}};
  /// # fn main() -> Result<(), Err> {
  /// // parse string as metric
  ...
  ///
  /// ```
  /// # use crate::polycvss::cvss::v4::{Impact, Metric};
  /// # fn main() {
  /// // convert metric to string
  ...
  ///
  /// ```
  /// # use crate::polycvss::cvss::v4::{Impact, Metric, Name};
  /// # fn main() {
  /// // get metric name
  ...
  ///
  /// ```
  /// # use crate::polycvss::cvss::{Err, v4::{Requirement, Metric}};
  /// # fn main() -> Result<(), Err> {
  /// // parse string as metric
  ...
  ///
  /// ```
  /// # use crate::polycvss::cvss::v4::{Requirement, Metric};
  /// # fn main() {
  /// // convert metric to string
  ...
  ///
  /// ```
  /// # use crate::polycvss::cvss::v4::{Requirement, Metric, Name};
  /// # fn main() {
  /// // get metric name
  ...
  ///
  /// ```
  /// # use crate::polycvss::cvss::{Err, v4::{ModifiedAttackVector, Metric}};
  /// # fn main() -> Result<(), Err> {
  /// // parse string as metric
  ...
  ///
  /// ```
  /// # use crate::polycvss::cvss::v4::{ModifiedAttackVector, Metric};
  /// # fn main() {
  /// // convert metric to string
  ...
  ///
  /// ```
  /// # use crate::polycvss::cvss::v4::{ModifiedAttackVector, Metric, Name};
  /// # fn main() {
  /// // get metric name
  ...
  ///
  /// ```
  /// # use crate::polycvss::cvss::{Err, v4::{ModifiedAttackComplexity, Metric}};
  /// # fn main() -> Result<(), Err> {
  /// // parse string as metric
  ...
  ///
  /// ```
  /// # use crate::polycvss::cvss::v4::{ModifiedAttackComplexity, Metric};
  /// # fn main() {
  /// // convert metric to string
  ...
  ///
  /// ```
  /// # use crate::polycvss::cvss::v4::{ModifiedAttackComplexity, Metric, Name};
  /// # fn main() {
  /// // get metric name
  ...
  ///
  /// ```
  /// # use crate::polycvss::cvss::{Err, v4::{ModifiedAttackRequirements, Metric}};
  /// # fn main() -> Result<(), Err> {
  /// // parse string as metric
  ...
  ///
  /// ```
  /// # use crate::polycvss::cvss::v4::{ModifiedAttackRequirements, Metric};
  /// # fn main() {
  /// // convert metric to string
  ...
  ///
  /// ```
  /// # use crate::polycvss::cvss::v4::{ModifiedAttackRequirements, Metric, Name};
  /// # fn main() {
  /// // get metric name
  ...
  ///
  /// ```
  /// # use crate::polycvss::cvss::{Err, v4::{ModifiedPrivilegesRequired, Metric}};
  /// # fn main() -> Result<(), Err> {
  /// // parse string as metric
  ...
  ///
  /// ```
  /// # use crate::polycvss::cvss::v4::{ModifiedPrivilegesRequired, Metric};
  /// # fn main() {
  /// // convert metric to string
  ...
  ///
  /// ```
  /// # use crate::polycvss::cvss::v4::{ModifiedPrivilegesRequired, Metric, Name};
  /// # fn main() {
  /// // get metric name
  ...
  ///
  /// ```
  /// # use crate::polycvss::cvss::{Err, v4::{ModifiedUserInteraction, Metric}};
  /// # fn main() -> Result<(), Err> {
  /// // parse string as metric
  ...
  ///
  /// ```
  /// # use crate::polycvss::cvss::v4::{ModifiedUserInteraction, Metric};
  /// # fn main() {
  /// // convert metric to string
  ...
  ///
  /// ```
  /// # use crate::polycvss::cvss::v4::{ModifiedUserInteraction, Metric, Name};
  /// # fn main() {
  /// // get metric name
  ...
  ///
  /// ```
  /// # use crate::polycvss::cvss::{Err, v4::{ModifiedImpact, Metric}};
  /// # fn main() -> Result<(), Err> {
  /// // parse string as metric
  ...
  ///
  /// ```
  /// # use crate::polycvss::cvss::v4::{ModifiedImpact, Metric};
  /// # fn main() {
  /// // convert metric to string
  ...
  ///
  /// ```
  /// # use crate::polycvss::cvss::v4::{ModifiedImpact, Metric, Name};
  /// # fn main() {
  /// // get metric name
  ...
  ///
  /// ```
  /// # use crate::polycvss::cvss::{Err, v4::{ModifiedSubsequentImpact, Metric}};
  /// # fn main() -> Result<(), Err> {
  /// // parse string as metric
  ...
  ///
  /// ```
  /// # use crate::polycvss::cvss::v4::{ModifiedSubsequentImpact, Metric};
  /// # fn main() {
  /// // convert metric to string
  ...
  ///
  /// ```
  /// # use crate::polycvss::cvss::v4::{ModifiedSubsequentImpact, Metric, Name};
  /// # fn main() {
  /// // get metric name
...
impl Metric {
  ...
  ///
  /// ```
  /// # use crate::polycvss::cvss::v4::{Metric, AttackVector, ProviderUrgency};
  /// # fn main() {
...
///
/// ```
/// # use crate::polycvss::cvss::{Err, v4::{AttackVector, AttackComplexity, AttackRequirements, PrivilegesRequired, UserInteraction, Impact, Metric, Vector}};
/// # fn main() -> Result<(), Err> {
...
///
/// ```
/// # use crate::polycvss::cvss::{Err, v4::{AttackVector, Metric, Vector}};
/// # fn main() -> Result<(), Err> {
/// // parse string as vector
/// let v: Vector = "CVSS:4.0/AV:N/AC:L/AT:N/PR:N/UI:N/VC:H/VI:H/VA:H/SC:H/SI:H/SA:H".parse()?;
///
...
///
/// ```
/// # use crate::polycvss::cvss::v4::Vector;
/// # fn main() {
...
impl Vector {
  ...
  ///
  /// ```
  /// # use crate::polycvss::cvss::{Err, v4::{ModifiedAttackVector, Vector, Metric, Name}};
  /// # fn main() -> Result<(), Err> {
  /// // parse vector string
  /// let v: Vector = "CVSS:4.0/AV:N/AC:L/AT:N/PR:N/UI:N/VC:H/VI:H/VA:H/SC:H/SI:H/SA:H".parse()?;
  ///
...
///
/// ```
/// # use crate::polycvss::cvss::{Err, v4::{MacroVector,Vector}};
/// # fn main() -> Result<(), Err> {
...
///
/// ```
/// # use crate::polycvss::cvss::{Err, v4::{Scores, Vector}};
/// # fn main() -> Result<(), Err> {
