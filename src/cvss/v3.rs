...
//!
//! ```
//! # use crate::polycvss::cvss::{Err, v3::{AttackVector, Vector, Metric, Name}};
//! # fn main() -> Result<(), Err> {
//! // parse vector string
...
//!
//! ```
//! # use crate::polycvss::cvss::{Err, v3::{Name, Vector}};
//! # fn main() -> Result<(), Err> {
//! // parse vector string
//! let v: Vector = "CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H".parse()?;
//!
...
//!
//! ```
//! # use crate::polycvss::cvss::{Err, Score, v3::Vector};
//! # fn main() -> Result<(), Err> {
...
///
/// ```
/// # use crate::polycvss::cvss::v3::{Group, Name};
/// # fn main() {
/// // get group
...
///
/// ```
/// # use crate::polycvss::cvss::v3::{AttackVector, Metric, Name};
/// # fn main() {
/// // get metric name
...
///
/// ```
/// # use crate::polycvss::cvss::v3::{AttackVector, Name};
/// # fn main() {
/// // check if metric is mandatory
...
///
/// ```
/// # use crate::polycvss::cvss::{Err, v3::{AttackVector, Metric}};
/// # fn main() -> Result<(), Err> {
...
///
/// ```
/// # use crate::polycvss::cvss::v3::{AttackVector, Metric};
/// # fn main() {
/// // convert metric to string
...
///
/// ```
/// # use crate::polycvss::cvss::{Err, v3::{AttackComplexity, Metric}};
/// # fn main() -> Result<(), Err> {
/// // parse string as metric
...
///
/// ```
/// # use crate::polycvss::cvss::v3::{AttackComplexity, Metric};
/// # fn main() {
/// // convert metric to string
...
///
/// ```
/// # use crate::polycvss::cvss::v3::{AttackComplexity, Metric, Name};
/// # fn main() {
/// // get metric name
...
///
/// ```
/// # use crate::polycvss::cvss::{Err, v3::{PrivilegesRequired, Metric}};
/// # fn main() -> Result<(), Err> {
/// // parse string as metric
...
///
/// ```
/// # use crate::polycvss::cvss::v3::{PrivilegesRequired, Metric};
/// # fn main() {
/// // convert metric to string
...
///
/// ```
/// # use crate::polycvss::cvss::v3::{PrivilegesRequired, Metric, Name};
/// # fn main() {
/// // get metric name
...
///
/// ```
/// # use crate::polycvss::cvss::{Err, v3::{UserInteraction, Metric}};
/// # fn main() -> Result<(), Err> {
/// // parse string as metric
...
///
/// ```
/// # use crate::polycvss::cvss::v3::{UserInteraction, Metric};
/// # fn main() {
/// // convert metric to string
...
///
/// ```
/// # use crate::polycvss::cvss::v3::{UserInteraction, Metric, Name};
/// # fn main() {
/// // get metric name
...
///
/// ```
/// # use crate::polycvss::cvss::{Err, v3::{Scope, Metric}};
/// # fn main() -> Result<(), Err> {
/// // parse string as metric
...
///
/// ```
/// # use crate::polycvss::cvss::v3::{Scope, Metric};
/// # fn main() {
/// // convert metric to string
...
///
/// ```
/// # use crate::polycvss::cvss::v3::{Scope, Metric, Name};
/// # fn main() {
/// // get metric name
...
///
/// ```
/// # use crate::polycvss::cvss::{Err, v3::{ExploitCodeMaturity, Metric}};
/// # fn main() -> Result<(), Err> {
/// // parse string as metric
...
///
/// ```
/// # use crate::polycvss::cvss::v3::{ExploitCodeMaturity, Metric};
/// # fn main() {
/// // convert metric to string
...
///
/// ```
/// # use crate::polycvss::cvss::v3::{ExploitCodeMaturity, Metric, Name};
/// # fn main() {
/// // get metric name
...
///
/// ```
/// # use crate::polycvss::cvss::{Err, v3::{RemediationLevel, Metric}};
/// # fn main() -> Result<(), Err> {
/// // parse string as metric
...
///
/// ```
/// # use crate::polycvss::cvss::v3::{RemediationLevel, Metric};
/// # fn main() {
/// // convert metric to string
...
///
/// ```
/// # use crate::polycvss::cvss::v3::{RemediationLevel, Metric, Name};
/// # fn main() {
/// // get metric name
...
///
/// ```
/// # use crate::polycvss::cvss::{Err, v3::{ReportConfidence, Metric}};
/// # fn main() -> Result<(), Err> {
/// // parse string as metric
...
///
/// ```
/// # use crate::polycvss::cvss::v3::{ReportConfidence, Metric};
/// # fn main() {
/// // convert metric to string
...
///
/// ```
/// # use crate::polycvss::cvss::v3::{ReportConfidence, Metric, Name};
/// # fn main() {
/// // get metric name
...
pub enum Metric {
  ...
  ///
  /// ```
  /// # use crate::polycvss::cvss::{Err, v3::{Impact, Metric}};
  /// # fn main() -> Result<(), Err> {
  /// // parse string as metric
  ...
  ///
  /// ```
  /// # use crate::polycvss::cvss::v3::{Impact, Metric};
  /// # fn main() {
  /// // convert metric to string
  ...
  ///
  /// ```
  /// # use crate::polycvss::cvss::v3::{Impact, Metric, Name};
  /// # fn main() {
  /// // get metric name
...
///
/// ```
/// # use crate::polycvss::cvss::{Err, v3::{AttackVector, AttackComplexity, PrivilegesRequired, UserInteraction, Scope, Impact, Metric, Vector}};
/// # fn main() -> Result<(), Err> {
...
///
/// ```
/// # use crate::polycvss::cvss::{Err, v3::{AttackVector, Metric, Vector}};
/// # fn main() -> Result<(), Err> {
/// // parse string as vector
/// let v: Vector = "CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H".parse()?;
///
...
///
/// ```
/// # use crate::polycvss::cvss::{Err, v3::{Vector}};
/// # fn main() -> Result<(), Err> {
...
///
/// ```
/// # use crate::polycvss::cvss::{Err, v3::{Scores, Vector}};
/// # fn main() -> Result<(), Err> {
/// // parse vector string
/// let v: Vector = "CVSS:3.1/AV:L/AC:L/PR:H/UI:N/S:U/C:N/I:N/A:H".parse()?;
///
...
///
/// ```
/// # use crate::polycvss::cvss::v3::Vector;
/// # fn main() {
...
impl Vector {
  ...
  ///
  /// ```
  /// # use crate::polycvss::cvss::{Err, v3::{ModifiedAttackVector, Vector, Metric, Name}};
  /// # fn main() -> Result<(), Err> {
  /// // parse vector string
  /// let v: Vector = "CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H".parse()?;
  ///
