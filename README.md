...
The test suite includes a large number of vector strings and scores.

These tests cases were generated by doing the following:

1. Extract the scoring code from the [NVD CVSS v3 calculator][v3-calc]
   and the [NVD CVSS v4 calculator][v4-calc].
